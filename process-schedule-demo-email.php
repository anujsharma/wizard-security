...
$firstName = ($_GET['demo_us_first_name']) ? $_GET['demo_us_first_name'] : $_POST['demo_us_first_name'];
$lastName = ($_GET['demo_us_last_name']) ? $_GET['demo_us_last_name'] : $_POST['demo_us_last_name'];
$email = ($_GET['demo_us_email']) ? $_GET['demo_us_email'] : $_POST['demo_us_email'];
$company = ($_GET['demo_us_company']) ? $_GET['demo_us_company'] : $_POST['demo_us_company'];
$message = ($_GET['demo_us_message']) ? $_GET['demo_us_message'] : $_POST['demo_us_message'];
$demoDate = ($_GET['demo_us_calendar']) ? $_GET['demo_us_calendar'] : $_POST['demo_us_calendar'];
$demoTime = ($_GET['demo_us_time_picker']) ? $_GET['demo_us_time_picker'] : $_POST['demo_us_time_picker'];
$demoTimeZone = ($_GET['demo_us_timezone_picker']) ? $_GET['demo_us_timezone_picker'] : $_POST['demo_us_timezone_picker'];
...
if (!$company) $errors[count($errors)] = 'Please enter your Company Name.';
...
if (!$errors) {
    ...
    <head></head>
    <body>
	<h1>Security Test Planning Wizard</h1>
	<h2>Schedule a Demo</h2>
    <table>
        <tr><td>First Name</td><td>' . $firstName . '</td></tr><br>
		<tr><td>Last Name</td><td>' . $lastName . '</td></tr><br>
        <tr><td>Email</td><td>' . $email . '</td></tr><br>
        <tr><td>Company</td><td>' . $company . '</td></tr><br>		
        <tr><td>Message</td><td>' . nl2br($message) . '</td></tr><br> 
		<tr><td>Demo Date</td><td>' . $demoDate . '</td></tr><br>
		<tr><td>Demo Time</td><td>' . $demoTime . '</td></tr><br>
		<tr><td>Demo Time Zone</td><td>' . $demoTimeZone . '</td></tr><br>	
